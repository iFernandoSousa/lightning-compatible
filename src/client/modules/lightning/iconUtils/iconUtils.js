...
const defaultTokenValueMap = Object.assign(Object.create(null), {
    'lightning.actionSprite': '../SLDS/icons/action-sprite/svg/symbols.svg',
    'lightning.actionSpriteRtl': '../SLDS/icons/action-sprite/svg/symbols.svg',
    'lightning.customSprite': '../SLDS/icons/custom-sprite/svg/symbols.svg',
    'lightning.customSpriteRtl': '../SLDS/icons/custom-sprite/svg/symbols.svg',
    'lightning.doctypeSprite': '../SLDS/icons/doctype-sprite/svg/symbols.svg',
    'lightning.doctypeSpriteRtl': '../SLDS/icons/doctype-sprite/svg/symbols.svg',
    'lightning.standardSprite': '../SLDS/icons/standard-sprite/svg/symbols.svg',
    'lightning.standardSpriteRtl': '../SLDS/icons/standard-sprite/svg/symbols.svg',
    'lightning.utilitySprite': '../SLDS/icons/utility-sprite/svg/symbols.svg',
    'lightning.utilitySpriteRtl': '../SLDS/icons/utility-sprite/svg/symbols.svg'
});
...
const getBaseIconPath = (category, direction) => {
    ...
    return (
        //getToken(nameMap[category]) || 
        getDefaultBaseIconPath(category, nameMap)
    );
};
