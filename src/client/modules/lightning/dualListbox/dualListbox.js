...
const labelComponentAssistiveText = 'Press Ctrl (Cmd on Mac) + Left Arrow or Ctrl (Cmd on Mac) + Right Arrow to move items between lists.';
const labelDownButtonAssistiveText = 'Move selection down';
const labelMaxError = 'Select at most {0} options';
const labelMaxHelp = '[and a maximum of {0}]';
const labelMinErrorPlural = 'Select at least {0} options';
const labelMinErrorSingular = 'Select at least 1 option';
const labelMinHelp = ' [and a minimum of {0}]';
const labelMinRequiredErrorPlural = 'At least {0} options must be selected';
const labelMinRequiredErrorSingular = 'At least 1 option must be selected';
const labelOptionLockAssistiveText = ': item cannot be removed from {0}';
const labelRequired = 'required';
const labelRequiredError = 'An option must be selected';
const labelRequiredOptionError = '{0} must be selected';
const labelUpButtonAssistiveText = 'Move selection u';
const labelMoveSelectionToAssistiveText = 'Move selection to {0}';
const labelLoadingText = 'Loading';

import { LightningElement, api, track } from 'lwc';
import { handleKeyDownOnOption } from './keyboard';
import { classSet, formatLabel } from 'lightning/utils';
import { assert, normalizeBoolean, getRealDOMId, classListMutation } from 'lightning/utilsPrivate';
import { InteractingState, FieldConstraintApi, normalizeVariant, VARIANT } from 'lightning/inputUtils';
