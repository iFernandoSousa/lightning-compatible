...
const labelAriaSelectedOptions = 'Selected Options:';
const labelDeselectOptionKeyboard = 'Press delete or backspace to remove';
const labelLoadingText = 'Loading';
const labelPillCloseButtonAlternativeText = 'Clear Selection';
